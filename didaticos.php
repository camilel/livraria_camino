<?php
  ...
  $sql = "select l.*, a.nome from livro l inner join autor a on a.id = l.id_autor where id_tipo_publico = 4;"; // faz o código SQL em uma variavel normal
